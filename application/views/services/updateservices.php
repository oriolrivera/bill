   ...
   <div class="container-fluid">
                     <div class="row">
                        ...
                        <div class="col-sm-5">
                           <div class="form-group">
                             Nombre encargado:
                              <input class="form-control" type="text" name="encargado" value="<?php echo $result->name_manager;?>" >
                        ...
                        <div class="col-sm-3">
                           <div class="form-group">
                              Precio:
                              <input class="form-control" type="text" name="precio" value="<?php echo $result->price;?>" >
                           </div>
                        </div>
                     </div>
                     <div class="row">
                      <div class="col-sm-2">
                           <div class="form-group">
                              Itbis:
                              <input class="form-control" type="text" name="itbis" value="<?php echo $result->itbis;?>" >
                           </div>
                        </div>
                        <div class="col-sm-2">
                           <div class="form-group">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="form-group">
                              Descripción:
                              <textarea class="form-control" id="ckeditor" name="descripcion" rows="3"><?php echo $result->description;?></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
